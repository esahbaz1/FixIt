...
public class KorisnikProfilResponseDTO {
    private Long id; private Long korisnikId; private String telefon;
    private String adresa; private UlogaKorisnika uloga; private Boolean aktivan;
    public KorisnikProfilResponseDTO(){}
